...
# ------------------------------------- Setup xp params ---------------------------------------
project_name="${WANDB_PROJECT:-rlreviewer}"
...
MODEL_PATH="${MODEL_PATH:-${REPLICATION_ROOT}/models/sft_model}"
...
SFT_MODEL="${SFT_MODEL:-$(basename "${MODEL_PATH}")}"
exp_name="${loss_mode}--${SFT_MODEL}_GSPO_LORA${START_TIME}"
CKPTS_DIR="${CKPTS_DIR:-${REPLICATION_ROOT}/checkpoints/${project_name}/${loss_mode}/${exp_name}}"
...
cr_rl_train_path="${CR_RL_TRAIN_PATH:-${REPLICATION_ROOT}/data/cr_rl_train.parquet}"
cr_rl_val_path="${CR_RL_VAL_PATH:-${REPLICATION_ROOT}/data/cr_rl_val.parquet}"
