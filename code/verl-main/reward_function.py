...
COMMENT_BLEU_WEIGHT = float(os.environ.get("COMMENT_BLEU_WEIGHT", "0.5"))
COMMENT_SEMANTIC_WEIGHT = float(os.environ.get("COMMENT_SEMANTIC_WEIGHT", "0.5"))
...
def compute_score(predict_str: str, ground_truth_str: str) -> dict:
    ...
    # The default reward balances lexical and semantic similarity. Set the
    # environment variables to 1/0 or 0/1 to reproduce either ablation.
    alpha = COMMENT_BLEU_WEIGHT
    beta = COMMENT_SEMANTIC_WEIGHT
